...
public class NetworkInteractableInstanceManager : Singleton<NetworkInteractableInstanceManager>
{
    ...
    private void Start()
    {
        NetworkManager.Singleton.OnServerStarted += () =>
        {
            ...
            currentlyOwnedInteractablesLookUp[NetworkManager.Singleton.LocalClientId] = new HashSet<NetworkInteractable>();
        ...
        NetworkManager.Singleton.OnClientConnectedCallback += (ulong clientID) =>
        {
            ...
            if (NetworkManager.Singleton.IsServer)
            {
                ...
                currentlyOwnedInteractablesLookUp[clientID] = new HashSet<NetworkInteractable>();
            }
        };
    ...
    {
        //create a new list
        List<NetworkInteractable> interactableList = new List<NetworkInteractable>();
    ...
    public NetworkInteractable lookupNetworkInteractable(int parentKey, int objectIndex)
    {
    ...
    private void handleClientDisconnect(ulong clientID)
    {
        ...
        foreach(NetworkInteractable networkInteractable in currentlyOwnedInteractablesLookUp[clientID])
        {
            //release ownership
    ...
    public void revokeOwnershipOfNetworkInteractable(NetworkInteractable networkInteractable)
    {
    ...
    private void networkInteractableOwnershipServerRequest(ulong senderID, FastBufferReader messagePayload)
    {
        ...
        NetworkInteractable targetInteractable = lookupNetworkInteractable(ownershipRequest.parentKey, ownershipRequest.objectIndex);
    ...
    private void expressNetworkInteractableOwnershipRevokationRequest(NetworkInteractable targetInteractable)
    {
    ...
    public void requestUpdateNetworkInteractableTransform(
        NetworkInteractable networkInteractable, 
    ...
    private void updateNetworkInteractableTransformClientBroadcast(ulong senderID, FastBufferReader messagePayload)
    {
        ...
        NetworkInteractable targetInteractable = lookupNetworkInteractable(transformRequest.parentKey, transformRequest.objectIndex);
