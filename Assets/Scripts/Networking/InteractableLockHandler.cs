...
public class InteractableLockHandler : Singleton<InteractableLockHandler>
{
    ...
    public bool requestInteractableLock(Interactable interactable, bool isLockoutRequest)
    {
    ...
    private void interactableLockServerRequest(ulong senderID, FastBufferReader messagePayload)
    {
        ...
        NetworkInteractable targetInteractable = NetworkInteractableInstanceManager.Instance.
    ...
    private void requestLockEngage(NetworkInteractable networkInteractable, ulong clientID)
    {
    ...
    private void requestLockDisengage(NetworkInteractable networkInteractable, ulong clientID)
    {
        //create a new lock ID object
        LockID lockID = new LockID()
        {
    ...
    public List<Interactable> requestCollapsingInteractableLockEngage(Interactable interactable, bool isSingleCollapse)
    {
        ...
        List<Interactable> lockableInteractables = interactable.getCollapsableInteractables(isSingleCollapse);
        Debug.Log($"theres {lockableInteractables.Count} interactables in the list");
        foreach(Interactable lockableInteractable in lockableInteractables)
        {
    ...
    public void requestInteractableLockCollapseDisengage(Interactable interactable,bool isSingleCollapse)
    {
        //get a list of all the collapsable interactables
        List<Interactable> collapsableInteracables = interactable.getCollapsableInteractables(isSingleCollapse);


        //iterate over each interactable in the collapsable list 
        foreach(Interactable collapsableInteracable in collapsableInteracables)
        {
