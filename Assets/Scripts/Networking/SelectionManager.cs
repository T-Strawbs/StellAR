...
public class SelectionManager : Singleton<SelectionManager>
{
    ...
    /// </summary>
    public NetworkInteractable currentSelection {  get; private set; }
   /// <summary>
   /// The subscribable event thats invoked when the current local selection is changed
   /// </summary>
    public UnityEvent<Transform> onLocalSelectionChanged = new UnityEvent<Transform>();
    /// <summary>
    ...
    public void explodeCurrentInteractable()
    {
        ...
        if(currentSelection is Interactable)
            ExplodableHandler.Instance.requestInteractableExplostion((Interactable)currentSelection);
    }
    ...
    public void collapseCurrentInteractableSingle()
    {
        ...
        if (currentSelection is Interactable)
            ExplodableHandler.Instance.requestInteractableCollapse((Interactable)currentSelection, isSingleCollapse);
    }
    ...
    public NetworkInteractable getCurrentSelectionParent() 
    {
