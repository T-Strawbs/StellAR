...
public class MakeInteractable : MonoBehaviour
{
    ...
    {
        initialiseInteractables(transform, null);
    }
    ...
    private void initialiseInteractables(Transform current, Transform parent)
    {
        ...
        Interactable currentInteractable = current.AddComponent<Interactable>();
        //add an explodable component to the current object
        Explodable currentExplodable = current.AddComponent<Explodable>();
        ...
        //we have to assign the Selectable components using depth first recursion due to some weird setup
        ...
        Selectable currentSelectable = current.AddComponent<Selectable>();
